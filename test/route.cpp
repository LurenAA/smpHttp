...
void handle_json_news(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  uv_work_t *work_req = new uv_work_t();
  work_req->data = new work_bind({res, cli});
...
void handle_member_change(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
...
void handle_login(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::POST)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
...
void get_members(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
...
void change_assets(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::POST)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
...
void get_assets(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::GET)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
...
void change_articles(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::POST)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
...
void get_articles(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::GET)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
...
void get_assets_inf(std::shared_ptr<smpHttp::HttpRequest> req, std::shared_ptr<smpHttp::HttpResponse> res)
{
  if (req->getMethod() != hpr::GET)
  {
    res->setHttpStatus(smpHttp::HTTP_METHOD_NOT_ALLOWED);
